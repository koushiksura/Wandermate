...
!(function (e, t) {
        ...
        var l = {
          ...
          getSelectorFromElement: function (e) {
            var t = e.getAttribute("data-target"),
              n = "querySelector";
            (t && "#" !== t) || (t = (e.getAttribute("href") || "").trim());
            var i = t;
            "#" === t.charAt(0) &&
              -1 === t.indexOf(",") &&
              ((t = t.substr(1)), (n = "getElementById"));
            try {
              return document[n](t) ? i : null;
            } catch (e) {
              return null;
            }
          },
      ...
      Te =
        ...
        m(document)
          .on(O.CLICK_DATA_API, T, function (e) {
            e.preventDefault();
            var t = e.target;
            m(t).hasClass(w) || (t = m(t).closest(A)),
              ...
              if (
                ...
                if (k(this._element).hasClass(Y)) {
                  k(l).addClass(i),
                    ...
                    k(s).addClass(n),
                    k(l).addClass(n);
                  var u = we.getTransitionDurationFromElement(s);
                  k(s)
      ...
      De =
        ...
        (be = (function () {
          ...
          return (
                  ...
                  oe(this._element)
                    .one(we.TRANSITION_END, function () {
                      oe(n._element).removeClass(me).addClass(pe).addClass(de),
                        ...
                        oe(n._element).trigger(ue.SHOWN);
                    })
            ...
            (e._getConfig = function (e) {
              return (
                ((e = l({}, fe, e)).toggle = Boolean(e.toggle)),
                we.typeCheckConfig(se, e, he),
                e
              );
            }),
  ...
  function Qe(e) {
    ...
    return { height: Ke("Height", t, n, i), width: Ke("Width", t, n, i) };
  }
  var Ye = (function () {
      function i(e, t) {
        for (var n = 0; n < t.length; n++) {
  ...
  var Tt,
        ...
        return (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  $t(this._element).removeClass(un),
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                $t(document.body).removeClass(fn),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
    ...
    Yi =
      ...
      (Ci = (function () {
        ...
        return (
          ...
          (e._activate = function (t) {
            ...
            n.hasClass(fi)
              ? (n.closest(vi).find(Ei).addClass(hi), n.addClass(hi))
              : (n.addClass(hi),
                n
                  .parents(pi)
                  .prev(mi + ", " + _i)
      ...
      ni(window).on(ci.LOAD_DATA_API, function () {
        for (
          var e = [].slice.call(document.querySelectorAll(ui)), t = e.length;
          t--;
        ...
        return (
          (e.show = function () {
            ...
            if (
              ...
              var s = Ti.Event(Ai.HIDE, { relatedTarget: this._element }),
                a = Ti.Event(Ai.SHOW, { relatedTarget: i });
              if (
                (i && Ti(i).trigger(s),
                ...
                var l = function () {
                  var e = Ti.Event(Ai.HIDDEN, { relatedTarget: n._element }),
                    t = Ti.Event(Ai.SHOWN, { relatedTarget: i });
