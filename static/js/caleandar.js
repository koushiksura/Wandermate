...
function createCalendar(calendar, element, adjuster) {
  ...
  function AddDateTime() {
    ...
    if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
      ...
      rwd.innerHTML =
        '<svg height="15" width="15" viewBox="0 0 75 100" fill="#2DCE89"><polyline points="0,50 75,0 75,100"></polyline></svg>';
    ...
    if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
      ...
      fwd.innerHTML =
        '<svg height="15" width="15" viewBox="0 0 75 100" fill="#2DCE89"><polyline points="0,0 75,50 0,100"></polyline></svg>';
  ...
  function AddDays() {
    ...
    for (var i = 0; i < calendar.Selected.Days; i++) {
      ...
      day.setAttribute(
        "data-date",
        calendar.Selected.getFullYear() +
          "/" +
          (calendar.Selected.getMonth() + 1).toString().padStart(2, "0") +
          "/" +
      ...
      for (var q = 0; q < calendar.Options.DisabledDates.length; q++) {
        if (
          calendar.Selected.getFullYear() +
            ...
            "/" +
            (i + 1).toString().padStart(2, "0") ==
          calendar.Options.DisabledDates[q]
        ) {
          day.className += " disableDay";
        }
      }
