...
!(function (t, e) {
  ...
  var r,
    ...
    Dn =
      ...
      (Y = "active"),
      (G = "slide"),
      (q = "paper_carousel-item-right"),
      (z = "paper_carousel-item-left"),
      (X = "paper_carousel-item-next"),
      (J = "paper_carousel-item-prev"),
      (Z = {
        ACTIVE: ".active",
        ACTIVE_ITEM: ".active.paper_carousel-item",
        ITEM: ".paper_carousel-item",
        NEXT_PREV: ".paper_carousel-item-next, .paper_carousel-item-prev",
        INDICATORS: ".paper_carousel-indicators",
        DATA_SLIDE: "[data-slide], [data-slide-to]",
        DATA_RIDE: '[data-ride="paper_carousel"]',
      }),
      ($ = (function () {
        function s(t, e) {
          (this._items = null),
