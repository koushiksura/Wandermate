...
+(function (a) {
  ...
  +(function (a) {
    ...
    var b = function (b, c) {
      (this.$element = a(b)),
        (this.$indicators = this.$element.find(".vid_carousel-indicators")),
        (this.options = c),
        (this.paused =
          this.sliding =
          this.interval =
    ...
    (b.DEFAULTS = { interval: 5e3, pause: "hover", wrap: !0 }),
      ...
      (b.prototype.slide = function (b, c) {
        ...
        var j = a.Event("slide.bs.vid_carousel", {
          relatedTarget: e[0],
          direction: g,
        });
    ...
    var c = a.fn.vid_carousel;
    (a.fn.vid_carousel = function (c) {
      return this.each(function () {
        var d = a(this),
          e = d.data("bs.vid_carousel"),
          f = a.extend({}, b.DEFAULTS, d.data(), "object" == typeof c && c),
          g = "string" == typeof c ? c : f.slide;
        e || d.data("bs.vid_carousel", (e = new b(this, f))),
          "number" == typeof c
            ? e.to(c)
            : g
            ? e[g]()
      ...
      (a.fn.vid_carousel.Constructor = b),
      (a.fn.vid_carousel.noConflict = function () {
        return (a.fn.vid_carousel = c), this;
      }),
      a(document).on(
        "click.bs.vid_carousel.data-api",
        ...
        function (b) {
          ...
          g && (f.interval = !1),
            e.vid_carousel(f),
            (g = d.attr("data-slide-to")) && e.data("bs.vid_carousel").to(g),
            b.preventDefault();
        }
      ),
      a(window).on("load", function () {
        a('[data-ride="vid_carousel"]').each(function () {
          var b = a(this);
          b.vid_carousel(b.data());
        });
      });
  })(jQuery),
  +(function (a) {
